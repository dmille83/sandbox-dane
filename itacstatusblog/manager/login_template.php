...
class OneFileLoginApplication
{
     ...
     */
    public function __construct($page_content_html)
    {
        $this->page_content = $page_content_html;
        $this->override_template_wrapper = false; //$override_all_html;
        ...
        if ($this->override_template_wrapper) {
            ...
            echo '<!DOCTYPE html>
              ...
              <div class="managerouterwrapper">
                ...
                <a href="blogpages.php">Blog Pages</a>
                <br>
                <br>';
    ...
    private function showPageLoginForm()
    {
        ...
        echo '<input id="login_input_username" type="text" name="user_name" required value="helpdesk"/> ';

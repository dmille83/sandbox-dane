...
function sagscroller(options){
	...
	this.setting={mode:'manual', inittype:'stunted', pause:6000, animatespeed:10000, ajaxsource:null, rssdata:null, refreshsecs:0, navpanel:{show:true, cancelauto:false}} //default settings
...
sagscroller.prototype={
	...
	scrollmsg:function(repeat){
		...
		this.$mainul.animate({top: endpoint}, setting.animatespeed, function(){
			...
			repeat=true // Dane - scroll forever!
			if (repeat)
